...
function FeaturedProject() {
  ...
  return (
    <div className="panel-tonal flex h-full min-h-0 min-w-0 flex-col overflow-hidden rounded-tl-[2rem] rounded-tr-[2rem] rounded-br-[2rem] rounded-bl-[3rem] bg-solar-projects p-6 text-solar-projects-foreground sm:p-8">
