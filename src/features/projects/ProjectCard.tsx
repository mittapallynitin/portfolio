...
function ProjectCard({ repo, index }: ProjectCardProps) {
  ...
  return (
    <div
      onClick={() => open({ type: "project", id: repo.name })}
      ...
      <ContentCard
        ...
        footerExtra={
          <a
            ...
            className="flex h-8 w-8 items-center justify-center rounded-full bg-white/10 text-muted-foreground transition-colors hover:bg-white/20 hover:text-foreground"
          >
